...
import { PublicClient, PkceCodes, NetworkRequestOptions, LogLevel, TemporaryCacheKeys, CodeResponse, TokenResponse, Account } from "@azure/msal-common";
...
describe("RedirectHandler.ts Unit Tests", () => {
    ...
    describe("handleCodeResponse()", () => {
        ...
        it("successfully handles response", async () => {
            ...
            sinon.stub(PublicClient.prototype, "handleFragmentResponse").returns(testCodeResponse);
            sinon.stub(PublicClient.prototype, "acquireToken").resolves(testTokenResponse);
